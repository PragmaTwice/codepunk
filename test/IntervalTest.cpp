...
const auto One = Interval(APSInt(llvm::APInt(32, 1), false));
...
TEST(Interval, ArthmeticOp) {
    ...
    ASSERT_TRUE(Interval(APSInt(llvm::APInt(32, 1), false), APSInt(llvm::APInt(32, 2), false))
        .equals(One + ZeroToOne));
    ASSERT_TRUE(Interval(APSInt(llvm::APInt(32, 0), false), APSInt(llvm::APInt(32, 2), false))
        .equals(ZeroToOne + ZeroToOne));

    ASSERT_TRUE(Zero.equals(Zero - Zero));
    ASSERT_TRUE(Interval(APSInt(llvm::APInt(32, -1, true), false),
            APSInt(llvm::APInt(32, 0), false)).equals(Zero - ZeroToOne));
    ASSERT_TRUE(ZeroToOne.equals(ZeroToOne - Zero));
    ASSERT_TRUE(ZeroToOne.equals(One - ZeroToOne));
    ASSERT_TRUE(Interval(APSInt(llvm::APInt(32, -1, false), false), APSInt(llvm::APInt(32, 1), false))
                        .equals(ZeroToOne - ZeroToOne));
...
TEST(Interval, OrderOp) {
    ...
    ASSERT_TRUE(Interval(APSInt(llvm::APInt(32, -1, false), false), APSInt(llvm::APInt(32, 0), false)) !=
        Interval(APSInt(llvm::APInt(32, 1, false), false), APSInt(llvm::APInt(32, 2), false)));
    ...
    ASSERT_TRUE((Interval(APSInt(llvm::APInt(32, -1, false), false), APSInt(llvm::APInt(32, 2), false)) <=
                 Interval(APSInt(llvm::APInt(32, 1, false), false), APSInt(llvm::APInt(32, 3), false)))
                 .equals(Ternary::Unknown));
